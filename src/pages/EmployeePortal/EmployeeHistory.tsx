      ...
      <Card>
        <CardContent className="p-4 md:p-6 flex flex-col md:flex-row gap-4 items-end">
          ...
          <button
            ...
            className="w-full md:w-auto h-10 px-4 py-2 bg-slate-100 hover:bg-slate-200 text-slate-700 border border-slate-200 rounded-lg text-xs font-semibold flex items-center justify-center space-x-2 transition-colors duration-150"
          >
            ...
            <TableBody>
              {filteredRecords.length === 0 ? (
                ...
                filteredRecords.map((rec) => (
                  <TableRow key={rec.id}>
                    <TableCell className="font-semibold font-mono text-slate-700 flex items-center gap-2">
