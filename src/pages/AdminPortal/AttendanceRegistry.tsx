            ...
            <TableBody>
              {registryRecords.length === 0 ? (
                ...
                registryRecords.map((rec) => (
                  <TableRow key={rec.id}>
                    <TableCell className="font-semibold text-foreground">{rec.employee_name}</TableCell>
                    <TableCell className="font-mono text-xs font-bold text-muted-foreground">{rec.employee_id}</TableCell>
