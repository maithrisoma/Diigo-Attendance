    ...
    <div className="space-y-6 text-left">
                  ...
                  <TableRow key={holiday.id}>
                    ...
                    <TableCell>
                      {holiday.is_recurring ? (
                        <span className="flex items-center gap-1 text-[11px] font-bold text-emerald-700 bg-emerald-50 border border-emerald-200/50 px-2 py-0.5 rounded-full w-max">
                          <Check className="h-3.5 w-3.5" />
                          Annual Repeat
                        </span>
                      ) : (
                        <span className="text-[11px] font-medium text-slate-400">One-time Off</span>
                      )}
                    </TableCell>
                    <TableCell className="text-right">
                      <div className="flex justify-end space-x-1.5">
                        ...
                        <Button
                          ...
                          className="h-8.5 w-8.5 text-slate-400 hover:text-[#EF4444] hover:bg-slate-100"
                        >
      ...
      <Modal isOpen={addOpen} onClose={() => setAddOpen(false)} title="Create Default Holiday" size="sm">
        <form onSubmit={handleAddSubmit} className="space-y-4">
          ...
          <div>
            <label className="text-xs font-bold text-slate-700 mb-1.5 block">Holiday Name</label>
            <Input
          ...
          <div>
            <label className="text-xs font-bold text-slate-700 mb-1.5 block">Holiday Date</label>
            <Input
              type="date"
          ...
          <div>
            <label className="text-xs font-bold text-slate-700 mb-1.5 block">Holiday Type</label>
            <Select
